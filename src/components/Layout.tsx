        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              <div className="text-2xl font-bold text-brand-purple mb-2">John Mulder</div>
            ...
            <div className="flex flex-col items-center md:items-end">
              ...
              <div className="flex space-x-4">
                <motion.a
                  href="https://github.com/johnmulder8"
                  target="_blank"
                ...
                <motion.a
                  href="https://www.linkedin.com/in/john-mulder-369b13354"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-muted-foreground hover:text-brand-purple transition-colors bg-secondary p-3 rounded-full"
                  whileHover={{ scale: 1.1 }}
                ...
                <motion.a
                  href="mailto:mjopowtop@gmail.com"
                  className="text-muted-foreground hover:text-brand-purple transition-colors bg-secondary p-3 rounded-full"
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.95 }}
                  aria-label="Email"
          ...
          <div className="text-muted-foreground text-sm text-center mt-8">
            © {new Date().getFullYear()} John Mulder. All rights reserved.
          </div>
        </div>
      </footer>
      <ScrollToTop />

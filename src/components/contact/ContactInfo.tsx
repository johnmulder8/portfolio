  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      details: "https://github.com/johnmulder8",
      link: "https://github.com/johnmulder8",
    },
    {
      icon: <MapPin className="h-5 w-5 text-brand-purple" />,
      title: "Location",
      details: "Mechanicsburg, PA 17055",
      link: "https://maps.google.com/?q=Mechanicsburg%2C+PA+17055",
    },
  ];
  ...
  const socialLinks = [
    {
      ...
      name: "GitHub",
      url: "https://github.com/johnmulder8",
    },
    {
      icon: <Linkedin className="h-5 w-5" />,
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/john-mulder-369b13354",
    }
  ];
